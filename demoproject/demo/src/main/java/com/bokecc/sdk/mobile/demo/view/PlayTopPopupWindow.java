...
public class PlayTopPopupWindow{
	...
	private RadioButton rb_first_subtitle,rb_second_subtitle,rb_two_subtitle;
	private OnSubtitleRadioButton onSubtitleRadioButton;

	public PlayTopPopupWindow(Context context, int height,OnSubtitleRadioButton onSubtitleRadioButton) {
		this.context = context;
		this.onSubtitleRadioButton = onSubtitleRadioButton;
		...
		rb_first_subtitle = findById(R.id.rb_first_subtitle, view);
		rb_second_subtitle = findById(R.id.rb_second_subtitle, view);
		rb_two_subtitle = findById(R.id.rb_two_subtitle, view);
		...
		onSubtitleRadioButton.getRadioButtons(rb_first_subtitle,rb_second_subtitle,rb_two_subtitle);
	}
