...
//                        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/roli.ttc");
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.iv_download_play:
                    PlayerUtil.downloadCurrentVideo(SpeedIjkMediaPlayActivity.this, videoId, verificationCode, isAudio);
                    break;
    ...
    private void changeVideo(int position, boolean isCompleted) {
        ...
        player.setVideoPlayInfo(videoId, ConfigUtil.USERID, ConfigUtil.API_KEY, verificationCode, SpeedIjkMediaPlayActivity.this);
        player.setSurface(surface);
        player.setAudioPlay(isAudio);
        player.prepareAsync();
    }
    ...
    private void initPlayTopPopupWindow() {
        ...
        playTopPopupWindow.setCheckNetwork(new CheckNetwork() {
            ...
            public void checkNet() {
                CustomDialogCheckNetwork customDialogCheckNetwork = new CustomDialogCheckNetwork(SpeedIjkMediaPlayActivity.this,videoId,videoPlayInfo);
