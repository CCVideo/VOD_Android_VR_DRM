...
public class CustomDialogInputVerifyCode extends Dialog {
    private Context context;
    private BtnCancelOrSureListener btnCancelOrSureListener;

    public CustomDialogInputVerifyCode(@NonNull Context context, BtnCancelOrSureListener btnCancelOrSureListener) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_input_verify_code, null);
        setContentView(view);
